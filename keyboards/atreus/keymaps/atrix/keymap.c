...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DV] = LAYOUT( /* Dvorak */
    ...
    KC_ESC,  KC_TAB, KC_LGUI,  KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  MO(_RS), KC_MINS, KC_SLSH, KC_ENT
  ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    TG(_LW), ML(_LW), KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  _______, KC_PDOT, KC_P0, KC_PEQL  ),
   ...
   */
  [_LW] = LAYOUT( /* [> LOWER <] */
    KC_MNXT, KC_VOLU, KC_BRIU, KC_SYSREQ, BL_INC,                    RGB_VAI,   KC_F7,   KC_F8,   KC_F9,   KC_F10  ,
    KC_MPLY, KC_MUTE, KC_PSCR, KC_PAUS,   BL_TOGG,                   RGB_TOG,   KC_F4,   KC_F5,   KC_F6,   KC_F11  ,
    KC_MPRV, KC_VOLD, KC_BRID, KC_APP,    BL_DEC,                    RGB_VAD,   KC_F1,   KC_F2,   KC_F3,   KC_F12  ,
    _______, _______, KC_LGUI, KC_LSFT,   KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,    TO(_DF), QWERTY,  DVORAK,  RESET )
};
