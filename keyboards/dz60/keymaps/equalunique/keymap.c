 ...
 */
  [_DEFAULT] = LAYOUT_true_hhkb( /* Basic QWERTY */
      ...
      KC_LSPO, ______,  KC_Z,    KC_X,    KC_C, KC_V, KC_B,   KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, MO(_FN), \
               KC_LGUI, KC_LALT,                  LT(_MOUSE, KC_SPC),                    KC_RALT, KC_RGUI \
      ),
 ...
 */
  [_MOUSE] = LAYOUT_hhkb(
      ______,   ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, \
      ______,   ______, ______, ______, ______, ______, KC_MS_WH_LEFT, KC_MS_WH_DOWN, KC_MS_WH_UP, KC_MS_WH_RIGHT, ______, ______, ______, ______,  \
      ______,   ______, KC_MS_BTN1, KC_MS_BTN2, KC_MS_BTN3, ______, KC_MS_LEFT, KC_MS_DOWN, KC_MS_UP, KC_MS_RIGHT, ______, ______, ______,  \
